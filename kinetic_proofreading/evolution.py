...
def evolve(N, mcsteps, T, t_stall, q, delta, n_samples, size, dsize, maxsize):
    """
        ...
        for t in range(mcsteps):
            ...
            if t==0:
                ...
                save_vars(track_speed, track_error, track_fpt, track_fptw, track_phi, track_S, track_k, track_kw, \
                      k_new_r, k_new_w, p_0, N, init, end, t_stall, params[2], q)
                track_time.append(t)
...
def evolve_from_ic(N, mcsteps, T, t_stall, q, delta, n_samples, size, dsize, maxsize, ic):
    """
